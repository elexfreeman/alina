                        ...
                        <ul class="userMenu ">
                            ...
                            <li class="phone-number">
                                <a href="callto:+12025550151">
                                    ...
                                    <span class="hidden-xs" style="margin-left:5px"> +1-202-555-0151 </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 no-margin no-padding">
                    <div class="pull-right">
                        <ul class="userMenu">
                            ...
                            <li class="hidden-xs">
                                <a href="#" data-toggle="modal" data-target="#ModalSignup"> Create  Account </a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content ProductDetailsList">
                            ...
                            <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                                ...
                                <li><a href="about-us-3.html"> About Us V3 <span class="label label-success">NEW</span>
                                    </a></li>
