<?php
/**
 * Plugin Name: DigiWidgets Image Editor FV
 * Plugin URI:
 * Description: DigiWidgets Image Editor FV allows you to edit images within your posts.  Consider upgrading to the full version to get the full range of features provided by this plugin.
 * Version: 1.05
...
if (!class_exists("DigiWidgets_image_editor")) {
    class DigiWidgets_image_editor
    {
        ...
        function my_admin_menu()
        {
            ...
            add_submenu_page('imageEditorPage.php', 'DigiWidgets Editor', 'Projects', 'launch_editor', 'imageEditorPage.php');
        }
